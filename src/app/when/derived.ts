import { When, IWhen } from '../../when/class'
import { compare, processArgs, processCommandString } from './util'
import { IValidator, IParser, IValidatorCallback } from '../../when/definition'
